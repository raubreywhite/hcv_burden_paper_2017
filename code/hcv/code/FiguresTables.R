...
FigureIncidence <- function(){
  ...
  q <- q + RAWmisc::theme_SMAO(v=2)
  q <- q + scale_x_continuous("")
  q <- q + scale_y_continuous("")
  q <- q + ggplot2::expand_limits(y=0)
  RAWmisc::SMAOpng(file.path(RAWmisc::PROJ$SHARED_TODAY,"Figure_Incidence.png"),landscape=TRUE)
  print(q)
...
FigureArea <- function(){
  ...
  RAWmisc::SMAOpng(file.path(RAWmisc::PROJ$SHARED_TODAY,"Figure_Area.png"),landscape=TRUE,h=0.5)
  print(q)
  RAWmisc::MakeFootnote("Yellow area denotes projections")
  dev.off()
}
...
FigureArea2 <- function(){
  ...
  RAWmisc::SMAOpng(file.path(RAWmisc::PROJ$SHARED_TODAY,"Figure_Area2.png"),landscape=TRUE,h=0.75)
  print(q)
  RAWmisc::MakeFootnote("Yellow area denotes projections")
  dev.off()
}
...
FigureESCAIDEArea <- function(){
  ...
  q <- q + scale_x_continuous("")
  q <- q + scale_y_continuous("",lim=c(0,20000))
  RAWmisc::SMAOpng(file.path(RAWmisc::PROJ$SHARED_TODAY,"Figure_ESCAIDEArea.png"),landscape=TRUE,h=0.75)
  print(q)
  RAWmisc::MakeFootnote("Yellow area denotes projections")
  dev.off()
}
...
FigureAge <- function(){
  ...
  RAWmisc::SMAOpng(file.path(RAWmisc::PROJ$SHARED_TODAY,"Figure_Age.png"),landscape=TRUE, h=0.75)
  print(q)
  RAWmisc::MakeFootnote("Yellow area denotes projections")
  dev.off()
}
...
FigureFitting <- function(){
  ...
  q <- q + scale_y_continuous("")
  RAWmisc::SMAOpng(file.path(RAWmisc::PROJ$SHARED_TODAY,"Figure_Fitting.png"),landscape=TRUE)
  print(q)
  dev.off()
}
...
FigureAgeDebut <- function(){
  ...
  RAWmisc::SMAOpng(file.path(RAWmisc::PROJ$SHARED_TODAY,"Figure_AgeDebut.png"),landscape=TRUE)
  print(q)
  dev.off()
...
FigurePWID <- function(){
  ...
  RAWmisc::SMAOpng(file.path(RAWmisc::PROJ$SHARED_TODAY,"Figure_PWID.png"),landscape=TRUE,h=0.5)
  print(q)
  dev.off()
...
FigureESCAIDENumberHCVInfected <- function(){
  ...
  q
  RAWmisc::SMAOpng(file.path(RAWmisc::PROJ$SHARED_TODAY,"Figure_ESCAIDEBar.png"),landscape=TRUE,h=0.75,w=0.5)
  print(q)
  dev.off()
}
...
FigureEnvelopePWIDPerc <- function(){
  ...
  RAWmisc::SMAOpng(file.path(RAWmisc::PROJ$SHARED_TODAY,"Figure_PWIDPerc.png"),landscape=TRUE)
  print(q)
  dev.off()
}
...
BurdenGraph <- function(){
  ...
  RAWmisc::SMAOpng(file.path(RAWmisc::PROJ$SHARED_TODAY,"Figure_BurdenProportion.png"),landscape=TRUE,h=0.6)
  print(q)
  RAWmisc::MakeFootnote("Yellow area denotes projections")
  dev.off()
}
...
DALYsPer100k <- function(){
  ...
  RAWmisc::SMAOpng(file.path(RAWmisc::PROJ$SHARED_TODAY,"Figure_BurdenPer100k.png"),landscape=TRUE,w=1)
  print(q)
  RAWmisc::MakeFootnote("Yellow area denotes projections")
  dev.off()
}
...
GraphNeedleAndGINI <- function(){
  ...
  q <- q + scale_x_continuous("")
  q <- q + scale_y_continuous("")
  RAWmisc::SMAOpng(file.path(RAWmisc::PROJ$SHARED_TODAY,"Figure_NeedleAndGINI.png"),landscape=TRUE,w=1)
  print(q)
  RAWmisc::MakeFootnote("Yellow area denotes projections")
  dev.off()
}
